...
create table if not exists DESPIDOBRIAN
(
	idDespido int(2),
	idRecluta int(10),
    razon  varchar(100),
...
alter table DESPIDOBRIAN add primary key(idDespido);
alter table DESPIDOBRIAN add Constraint fkRecluta foreign key(idRecluta) references RECLUTAMIENTO (idRecluta);
